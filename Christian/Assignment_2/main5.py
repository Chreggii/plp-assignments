...
sp.io.wavfile.write(
    f"{dir}/sound/{sorter}_sound.wav", F_SAMPLE, wav_data)
...
def update(frame):
    ...
    # fig.savefig(
    #     f"Christian/Assignment 2/frames/{sorter}_frame{frame:05.0f}.png")
...
if __name__ == "__main__":
    ...
    cmd_str = f"ffmpeg -i {dir}/videos/video.mp4 -i {dir}/sound/Quick_sound.wav -map 0 -map 1:a -c:v copy -shortest {dir}/output.mp4"
